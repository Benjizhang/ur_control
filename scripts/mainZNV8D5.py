# exp: probe slides 20 cm along 0 deg 3 times in each exp.
...
if __name__ == '__main__':
    ...
    for j in range(3,8): # <<<<<<
        ...
        for i in range(3):
            ...
            # start
            x_s_wldf = initPtx + i * 0.1
            y_s_wldf = initPty

            # goal
            x_e_wldf = initPtx + i * 0.1
                ...
                while not listener.read_finish_flag():
                    ...
                    if listener.get_force_val() is not None:
                        ...
                        if isSaveForce ==  1:
                            ...
                            with open('/home/zhangzeqing/Nutstore Files/Nutstore/{}/{}/znv_exp{}.csv'.format(fd_name,j+1,i),'a',newline="\n")as f:
                                f_csv = csv.writer(f) # <<<<<<
